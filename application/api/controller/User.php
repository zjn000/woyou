...
class User extends Api{
    ...
    public function bind_phone(){
        ...
        $userInfo['is_bind'] == 1 && $this->jsonReturn(400,'手机已绑定');
        ...
        if ($errCode == 0) {
            ...
            Db::name('user')->where(['openid'=>$userInfo['openid']])->update(['phone'=>$objData->phoneNumber,'is_bind'=>1]);
            Session::set('userInfo')['is_bind'] = 1;

            //推送用户编号id为1的优惠券一张
            model('UserCoupon')->pushCoupon($userInfo['id'],1);

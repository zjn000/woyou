...
class WxPayConfig
{
	 ...
	 * @var string
	 */
	const APPID     = 'wx5daf9ce4cabfdaf5';
	const MCHID     = '1493392132';
	const KEY       = 'stwoyou20171208woyoubianliELENAq';
	const APPSECRET = '00b07427db71490dbceffdf7cee0e8ef';
	...
	//=======【异步通知地址】=====================================
	const NOTIFY_URL = 'https://www.stwoyou.com/api/Wxnotify/index';

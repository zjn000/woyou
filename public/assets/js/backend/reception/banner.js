define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'reception/banner/index',
                    add_url: 'reception/banner/add',
                    edit_url: 'reception/banner/edit',
                    del_url: 'reception/banner/del',
                    multi_url: 'reception/banner/multi',
                    table: 'banner',
                }
            });

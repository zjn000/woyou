define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'reception/bulletmap/index',
                    add_url: 'reception/bulletmap/add',
                    edit_url: 'reception/bulletmap/edit',
                    del_url: 'reception/bulletmap/del',
                    multi_url: 'reception/bulletmap/multi',
                    table: 'bullet_map',
                }
            });

define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'faq/purchasegoods/index',
                    add_url: '',
                    edit_url: '',
                    del_url: '',
                    multi_url: '',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'purchase_time', title: __('Purchase_time'),formatter: Table.api.formatter.datetime, operate: 'BETWEEN', type: 'datetime', addclass: 'datetimepicker', data: 'data-date-format="YYYY-MM-DD"'},
